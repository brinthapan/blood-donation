                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <select name="dropdown" class="nav-link dropdown-toggle"  id="navbarDropdown" role="button" data-toggle="dropdown" onchange="window.location.href = this.value;">
                                    <option value="">My Account</option>
                                    <option value="profile.php">Profile</option>
                                    <option value="change-password.php">Change Password</option>
                                    <option value="request-received.php">Request Received</option>
